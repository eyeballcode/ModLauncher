...
public class XZOutputStream extends FinishableOutputStream {
     ...
     * @throws UnsupportedOptionsException unsupported filter chain, or trying to change
     ...
     * @throws XZIOException <code>finish()</code> or <code>close()</code>
     *                       was already called
     ...
     * @throws XZIOException XZ Stream has grown too big: total file size
